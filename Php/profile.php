      ...
      <nav class="nav-extended nav-fixed teal lighten-3 z-depth-1">
        <div class="nav-wrapper">
          ...
          <ul id="nav-mobile" class="right">
            ...
            <li>
              <a href="jobpost.html" class="btn-flat" id="jobpost">Post Job</a>
            </li>
          </ul>
        </div>
      </nav>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="right-align">
            <a href="update_profile.html" class="waves-effect waves-light btn-flat right profileDlt"
              ...
              <form action="profile" method="post">
                <div class="row">
                  <div class="col s12 l6 m6">
                   <h6>Name : Sumaiya islam mim </h6>
                  </div>
                  <div class="col s12 l6 m6">
                   <h6>Address :Matuail</h6>
                  </div>
                </div>
                <div class="row">
                  <div class="col s12 l6 m6">
                ...
                <div class="row">
                  <div class="col s12 l6 m6">
                   <h6>Job :Software Tester</h6>
                  </div>
                  <div class="col s12 l6 m6">
                   <h6>Company:Google </h6>
                  </div>
                </div>                
              </form>
            </div>
